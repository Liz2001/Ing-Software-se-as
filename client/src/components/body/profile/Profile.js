  ...
  const handleChangeAvatar = async (event) => {
    ...
    try {
      ...
      if (!file) {
        return setData({
          ...data,
          err: "Ningún archivo fue cargado.",
          success: "",
        });
      }
      if (file.size > 1024 * 1024) {
        return setData({
          ...data,
          err: "El tamaño de la imagen debe ser menor a 1mb.",
          success: "",
        });
      }
      if (file.type !== "image/jpeg" && file.type !== "image/png") {
        return setData({
          ...data,
          err: "Formatos de archivo no soportados. Debe ser jpeg o png.",
          success: "",
        });
      }
          ...
          <div className="col-left">
            ...
            <div className="mb-3">
              <em className="form-text" style={{ color: "crimson" }}>
                * Si actualizas tu contraseña desde tu perfil de usuario, no
                podrás loguearte rápidamente por Google o Facebook.
              </em>
            </div>
            ...
            <div className="mt-5">
              <h1 className="fw-bold fs-4" style={{color: 'teal'}}>REPORTE DEL ALUMNO:</h1>
              <p className="fs-5" >
                El alumno lleva un {" "}
                {
