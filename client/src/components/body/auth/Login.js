        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <div className="form-text">
              * Nunca compartiremos tu dirección de email con otros.
            </div>
          </div>
          ...
          <div className="mb-3">
            ...
            ></input>
            <div className="form-text">
              * Tu contraseña debe ser de 8-20 caracteres, contener letras y
              números, y no debe tener espacios, caracteres especiales o emojis.
            </div>
          </div>
